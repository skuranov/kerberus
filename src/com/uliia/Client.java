...
public class Client extends JFrame {
    ...
    JPanel p = new JPanel();
    JButton b = new JButton("Server action");
    JTextArea textArea = new JTextArea("Output:", 30, 65 );

    public static void main(String[] args) {
        final Client client = new Client();
        client.b.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                PrintStream printStream = new PrintStream(new CustomOutputStream(client.textArea));
    ...
    public static void startAction(Client client){
        try {
            ...
            System.setProperty("java.security.auth.login.config", "C:\\study\\kerberos\\out\\production\\kerberos\\jaas.conf");
